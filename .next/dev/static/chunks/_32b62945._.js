...
function LoginForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError(null);
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["config"].apiBaseUrl}/login`, {
                method: "POST",
                headers: {
...
//# sourceMappingURL=_32b62945._.js.map